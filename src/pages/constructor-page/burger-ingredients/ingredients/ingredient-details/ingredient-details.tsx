  ...
  return (
    <div className={styles.content}>
      ...
      <div className={styles.properties}>
        <div data-cy='ingredient-data-calories' className={styles.property}>
          <span className='text text_type_main-default text_color_inactive'>Калории,ккал</span>
          <span className='text text_type_digits-default text_color_inactive'>
            {ingredient.calories}
          </span>
        </div>
        <div data-cy='ingredient-data-proteins' className={styles.property}>
          <span className='text text_type_main-default text_color_inactive'>Белки, г</span>
          <span className='text text_type_digits-default text_color_inactive'>
            {ingredient.proteins}
          </span>
        </div>
        <div data-cy='ingredient-data-fat' className={styles.property}>
          <span className='text text_type_main-default text_color_inactive'>Жиры, г</span>
          <span className='text text_type_digits-default text_color_inactive'>
            {ingredient.fat}
          </span>
        </div>
        <div data-cy='ingredient-data-carbohydrates' className={styles.property}>
