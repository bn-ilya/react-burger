...
export default function Ingredients() {
  ...
  const scrollHandler = (e) => {
    ...
    const titlesPositions = [
      {
        element: titleBuns,
        value: titleBuns.current.getBoundingClientRect().top,
      },
      {
        element: titleSauces,
        value: titleSauces.current.getBoundingClientRect().top,
      },
      {
        element: titleMains,
        value: titleMains.current.getBoundingClientRect().top,
      },
    ];
