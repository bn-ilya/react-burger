...
export const selectUserDataRequest = (state) =>
  state.profile.getUserDataRequest;
...
export const selectUpdateUserDataRequest = (state) =>
  state.profile.updateUserDataRequest;

export const selectIsForgotPassword = (state) =>
...
export const selectForgotPasswordRequest = (state) =>
